...
# Autodesk Platform Services (APS) Development Guidelines

## Overview
This project integrates with Autodesk Platform Services APIs for construction management, data handling, and authentication. Follow these guidelines when working with APS-related code.

## Core Principles

### API Integration Standards
- Always use proper OAuth2 authentication flows for APS services
- Implement proper error handling for all API calls (400, 401, 403, 404, 500 responses)
- Use appropriate regional headers (US, EMEA) based on data location requirements
- Include User-Id headers when using 2-legged authentication with user impersonation

### Data Management Best Practices
- Leverage the Data Management API for unified access across BIM 360, Fusion Team, and Object Storage
- Use proper filtering and pagination for large datasets (limit/offset parameters)
- Implement proper date filtering using ISO 8601 format (YYYY-MM-DDThh:mm:ss.sz)
- Cache frequently accessed data to minimize API calls

### Construction Issues Workflow
- Always validate issue types and subtypes before creating issues
- Use proper custom attribute handling with UUID-based filtering
- Implement proper assignee management (user, company, role types)
- Handle issue status transitions according to permitted statuses

### Model Derivative Integration
- Use Model Derivative API for CAD format translations
- Implement proper file upload/download workflows with OSS
- Handle large file processing asynchronously

### Security & Authentication
- Use Secure Service Account (SSA) for service-to-service authentication
- Generate JWT tokens using private keys for service accounts
- Implement proper webhook validation for event notifications
